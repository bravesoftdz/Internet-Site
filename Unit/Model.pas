...
type
  ...
  MyStore = class
  const
    LabelCaption = 'ÊÎÍÔÈÃÓĞÀÒÎĞ ÑÈÑÒÅÌÍÎÃÎ ÁËÎÊÀ';
  private
  ...
  public
    ...
    function SelectCconfigurationOfficeEconom(Label1: TLabel;
      ADOQuery1: TADOQuery; DBText1: TDBText; DBText2: TDBText;
      DBText3: TDBText; DBText4: TDBText; DataSource1: TDataSource): TADOQuery;
    ...
    function SelectElement(ADOQuery1: TADOQuery; DBText1: TDBText;
      DBText2: TDBText; DBText3: TDBText; DBText4: TDBText;
      DataSource1: TDataSource): TADOQuery;
    function UpdateConfiguration(Label1: TLabel; ADOQuery1: TADOQuery;
...
function MyStore.CleanAndSelectConfiguration(Label1: TLabel;
  ADOQuery1: TADOQuery; DBText1: TDBText; DBText2: TDBText; DBText3: TDBText;
  DBText4: TDBText; DataSource1: TDataSource): TADOQuery;
begin
...
function MyStore.Selectdescription(Label1: TLabel; ADOQuery1: TADOQuery;
  DBText1, DBText2, DBText3, DBText4: TDBText; DataSource1: TDataSource)
  : TADOQuery;
begin
...
function MyStore.SelectElement(ADOQuery1: TADOQuery;
  DBText1, DBText2, DBText3, DBText4: TDBText; DataSource1: TDataSource)
  : TADOQuery;
begin
  ADOQuery1.Connection := ADOConnection1;
...
function MyStore.GetDataSource(ExecSQL1, SQL2, SQL3, SQL4, SQL5, SQL6, SQL7,
  SQL8, SQL9, SQL10: string; ADOQuery: TADOQuery; DataSource: TDataSource)
  : TDataSource;
begin
...
begin
  result := GetDataSource
    ...
    ' OR element.idelement=configuration.col8 OR element.idelement=configuration.col9 OR element.idelement=configuration.col10 ',
    ' OR element.idelement=configuration.col11 OR element.idelement=configuration.col12 OR element.idelement=configuration.col13) ',
    ' AND configuration.idconfiguration=' + idconfiguration +
    ' ORDER BY idelement  ) AS ACTION ;', '', '', ADOQuery2, DataSource2);
